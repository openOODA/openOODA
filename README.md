...
[![Version](https://img.shields.io/badge/version-v2.10.0-00f2fe.svg?style=flat-square)](https://github.com/openOODA/openOODA)
...
| 5 | [`ROADMAP.oot`](ROADMAP.oot) | Phase & Milestone Timeline (Current: v2.10.0) | $\le 256$ lines | `scripts/check_board.oo` |
